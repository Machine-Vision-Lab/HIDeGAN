...
from util.metrics import psnr, ssim, mape
from util.util import tensor2hsi

"""
Problem : generated hsi images are blurry

Ideas
Use different loss functions alernatively
Use convtranspose2d : One additional tip suggests using the kernel size that is divisible by the stride size in the generator model to avoid the so-called “checkerboard” artifact 
...
Use nearest intepolation - seems to work
"""
...
class CycleGANModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument('--val_data_path', type=str, default='./datasets/d1/', help='data folder path for checking performance of model on the validation dataset')
            ...
            parser.add_argument('--lambda_GAN', type=float, default='3', help='weight for GAN loss')
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['D_A', 'G_A', 'cycle_A', 'D_B', 'G_B', 'cycle_B', 'vgg_fake', 'vgg_cycle','idt_A','idt_B']
