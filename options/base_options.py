...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--path_variable', required=True, default='A_in', help='path to images from trainA (allows multiple models to be trained on different dataset) (A_in : indoor, A_out : outdoor)')
        ...
        parser.add_argument('--netG_A', type=str, default='unet_256', help='specify generator architecture from AtoB [resnet_9blocks | resnet_6blocks | unet_256 | unet_128 |hscnn_2blocks]')
        parser.add_argument('--netG_B', type=str, default='unet_256', help='specify generator architecture from BtoA [resnet_9blocks | resnet_6blocks | unet_256 | unet_128]')
